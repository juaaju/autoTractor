...
from ekfnparam2 import EKFSensorFusion  # sesuaikan path modul EKF-mu
...
class IMUHandler:
    ...
    def update_loop(self):
        while self.running:
            ...
            self.gyro = math.radians(data_gyro['z'])  # konversi langsung
